...
impl SigVerifyStage {
    ...
    fn verifier<T: SigVerifier>(
        ...
        let non_discarded_packets = perf::discard::discard_batches_randomly(
            &mut batches,
            MAX_DEDUP_BATCH,
            num_packets,
        );
...
mod tests {
    ...
    use perf::{packet::to_packet_batches, sigverify::count_packets_in_batches};
    use std::sync::mpsc::channel;
    use {super::*, perf::packet::Packet};
