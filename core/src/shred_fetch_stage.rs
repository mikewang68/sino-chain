...
use {
    ...
    lru::LruCache,
    ledger::shred::{get_shred_slot_index_type, ShredFetchStats},
    perf::{
...
mod tests {
    use {
        super::*,
        ledger::{blockstore::MAX_DATA_SHREDS_PER_SLOT, shred::Shred},
    };
    ...
    fn test_data_code_same_index() {
        ...
        let coding = ledger::shred::Shredder::generate_coding_shreds(
            &[shred],
