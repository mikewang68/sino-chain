use {
    ...
    runtime::{bank::Bank, epoch_stakes::NodeIdToVoteAccounts},
    sdk::{
...
#[cfg(test)]
mod tests {
    use {super::*, runtime::epoch_stakes::NodeVoteAccounts};
    ...
    fn test_best_peer_2() {
        ...
        let k1 = sdk::pubkey::new_rand();
        let k2 = sdk::pubkey::new_rand();
