...
use {
    ...
    perf::{self, packet::PacketBatch, recycler_cache::RecyclerCache},
...
impl SigVerifier for ShredSigVerifier {
    fn verify_batches(
        ...
        perf::sigverify::mark_disabled(&mut batches, &r);
        batches
    }
}
...
pub mod tests {
    ...
    fn test_sigverify_shreds_verify_batches() {
        ...
        let num_packets = perf::sigverify::count_packets_in_batches(&batches);
