use {
    ...
    ledger::blockstore_processor::{ConfirmationProgress, ConfirmationTiming},
    runtime::{bank::Bank, bank_forks::BankForks, vote_account::VoteAccount},
...
mod test {
    ...
    fn test_add_vote_pubkey() {
        ...
        let mut vote_pubkey = sdk::pubkey::new_rand();
        ...
        vote_pubkey = sdk::pubkey::new_rand();
    ...
    fn test_add_node_pubkey_internal() {
        ...
        let vote_account_pubkeys: Vec<_> = std::iter::repeat_with(sdk::pubkey::new_rand)
        ...
        let mut stats = PropagatedStats::default();
        let mut node_pubkey = sdk::pubkey::new_rand();
