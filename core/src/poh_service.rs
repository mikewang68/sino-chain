...
impl PohService {
    pub fn new(
        ...
        let tick_producer = Builder::new()
            .name("sino-poh-service-tick_producer".to_string())
            .spawn(move || {
                sys_tuner::request_realtime_poh();
...
mod tests {
    ...
    use ledger::genesis_utils::{create_genesis_config, GenesisConfigInfo};
    use ledger::leader_schedule_cache::LeaderScheduleCache;
    use ledger::{blockstore::Blockstore, get_tmp_ledger_path};
    use measure::measure::Measure;
    use perf::test_tx::test_tx;
    ...
    fn test_poh_service() {
        ...
        let ledger_path = get_tmp_ledger_path!();
        {
            ...
            let entry_producer = {
                ...
                Builder::new()
                    .name("sino-poh-service-entry_producer".to_string())
                    .spawn(move || {
                        let now = Instant::now();
                        let mut total_us = 0;
