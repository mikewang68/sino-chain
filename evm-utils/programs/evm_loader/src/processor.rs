...
mod test {
    ...
    use sdk::native_loader;
    use sdk::program_utils::limited_deserialize;
    use sdk::pubkey::Pubkey;
    use sdk::sysvar::rent::Rent;
    use sdk::{
    ...
    struct EvmMockContext {
        ...
        feature_set: sdk::feature_set::FeatureSet,
    }
    ...
    impl EvmMockContext {
        fn new(evm_balance: u64) -> Self {
            ...
            Self {
                ...
                feature_set: sdk::feature_set::FeatureSet::all_enabled(),
            }
        }
    ...
    fn all_ixs() -> Vec<sdk::instruction::Instruction> {
    ...
    fn account_by_key(pubkey: solana::Address) -> sdk::account::AccountSharedData {
        match &pubkey {
            id if id == &crate::ID => {
                native_loader::create_loadable_account_for_test("EVM Processor")
            }
            id if id == &sdk::sysvar::rent::id() => sdk::account::Account {
                lamports: 10,
