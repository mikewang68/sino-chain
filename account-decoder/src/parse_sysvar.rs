#[allow(deprecated)]
use sdk::sysvar::{fees::Fees, recent_blockhashes::RecentBlockhashes};
use {
    crate::{
...
mod test {
    ...
    use {
        super::*,
        sdk::{account::create_account_for_test, fee_calculator::FeeCalculator, hash::Hash},
    };
    ...
    fn test_parse_sysvars() {
        ...
        let bad_pubkey = sdk::pubkey::new_rand();
