...
lazy_static! {
    ...
    static ref CONFIG_PROGRAM_ID: Pubkey = config_program::id();
...
impl From<account_program::ParseError> for ParseAccountError {
...
impl From<relying_party_program::ParseError> for ParseAccountError {
...
mod test {
    ...
    fn test_parse_account_data() {
        ...
        let other_program = sdk::pubkey::new_rand();
        let data = vec![0; 4];
