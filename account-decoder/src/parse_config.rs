use {
    ...
    bincode::deserialize,
    serde_json::Value,
    config_program::{get_config_data, ConfigKeys},
    sdk::{
        pubkey::Pubkey,
...
mod test {
    use {
        ...
        config_program::create_config_account, sdk::account::ReadableAccount,
    };
    ...
    fn test_parse_config() {
        ...
        let info_pubkey = sdk::pubkey::new_rand();
        ...
        assert_eq!(
            ...
            ConfigAccountType::ValidatorInfo(UiConfig {
                ...
                config_data: serde_json::from_str(r#"{"name":"Sino"}"#).unwrap(),
            }),
        );
