...
mod tests {
    ...
    fn test_withdraw_stake() {
        ...
        // reset balance
        stake_account.borrow_mut().set_wens(stake_lamports);
    ...
    fn test_dbg_stake_minimum_balance() {
        ...
        panic!(
            ...
            minimum_balance,
            minimum_balance as f64 / sdk::native_token::LAMPORTS_PER_VLX as f64
        );
    }
