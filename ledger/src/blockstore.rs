...
pub fn create_new_ledger_from_name_auto_delete(
    ...
    let _root_hash =
        sdk::genesis_config::evm_genesis::generate_evm_state_json(&evm_state_json).unwrap();
...
pub mod tests {
    use {
        ...
        sino_entry::entry::{next_entry, next_entry_mut},
        runtime::bank::{Bank, RewardType},
        sdk::{
            hash::{self, hash, Hash},
        ...
        storage_proto::convert::generated,
        transaction_status::{InnerInstructions, Reward, Rewards, TransactionTokenBalance},
    ...
    */
    ...
    fn test_persist_transaction_status() {
        ...
        // insert value
        let status = TransactionStatusMeta {
            status: sdk::transaction::Result::<()>::Err(TransactionError::AccountNotFound),
            fee: 5u64,
        ...
        // insert value
        let status = TransactionStatusMeta {
            status: sdk::transaction::Result::<()>::Ok(()),
            fee: 9u64,
            pre_balances: pre_balances_vec.clone(),
            post_balances: post_balances_vec.clone(),
            inner_instructions: Some(inner_instructions_vec.clone()),
    ...
    fn do_test_lowest_cleanup_slot_and_special_cfs(
        ...
        let address0 = sdk::pubkey::new_rand();
        let address1 = sdk::pubkey::new_rand();
        blockstore
            .write_transaction_status(
                lowest_cleanup_slot,
                signature1,
    ...
    fn test_map_transactions_to_statuses() {
        ...
        for x in 0..4 {
            ...
            let status = TransactionStatusMeta {
                status: sdk::transaction::Result::<()>::Err(
    ...
    fn make_large_tx_entry(num_txs: usize) -> Entry {
        let txs: Vec<_> = (0..num_txs)
            ...
            .map(|_| {
                ...
                sdk::system_transaction::transfer(&keypair0, &to, 1, Hash::default())
            })
            .collect();
