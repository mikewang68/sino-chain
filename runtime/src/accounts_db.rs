...
pub mod tests {
    ...
    fn assert_load_account(
        ...
        let (account, slot) = accounts
            .load_without_fixed_root(&ancestors, &pubkey)
            .unwrap();
        assert_eq!((account.wens(), slot), (expected_lamports, slot));
    }
    ...
    fn test_storage_finder() {
        ...
        let lamports = 100;
        let data_len = 8190;
        let account = AccountSharedData::new(lamports, data_len, &sdk::pubkey::new_rand());
    ...
    fn test_scan_flush_accounts_cache_then_clean_drop() {
        ...
        */
        ...
        let account = db
            ...
            .unwrap();
        assert_eq!(account.0.wens(), zero_lamport_account.wens());
