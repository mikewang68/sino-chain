...
//!
//! <https://docs.sino.com/implemented-proposals/persistent-account-storage>
...
pub mod test_utils {
    use {
        ...
        sdk::{account::AccountSharedData, pubkey::Pubkey},
...
pub mod tests {
    use {
        ...
        rand::{thread_rng, Rng},
        sdk::{account::WritableAccount, timing::duration_as_ms},
        std::time::Instant,
    };
