...
impl StakesCache {
    ...
    pub fn is_stake(account: &AccountSharedData) -> bool {
        vote_program::check_id(account.owner())
...
pub mod tests {
    use {
        ...
        sdk::{account::WritableAccount, pubkey::Pubkey, rent::Rent},
        stake_program::stake_state,
        vote_program::vote_state::{self, VoteState, VoteStateVersions},
    };
    ...
    pub fn create_staked_node_accounts(
        ...
        let vote_account =
            vote_state::create_account(&vote_pubkey, &sdk::pubkey::new_rand(), 0, 1);
        (
