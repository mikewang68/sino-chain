...
use sdk::pubkey::{Pubkey, PUBKEY_BYTES};

sdk::declare_id!("TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA");

pub(crate) mod new_token_program {
    sdk::declare_id!("nTok2oJvx1CgbYA2SznfJLmnKLEL6sYdh2ypZms2nhm");
}
...
pub mod native_mint {
    sdk::declare_id!("So11111111111111111111111111111111111111112");
