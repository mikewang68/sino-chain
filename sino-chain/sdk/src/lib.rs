...
// Allows macro expansion of `use ::sdk::*` to work within this crate
...
/// use std::str::FromStr;
/// use sdk::{declare_id, pubkey::Pubkey};
///
/// # mod item_wrapper {
/// #   use sdk::declare_id;
...
/// assert_eq!(ID, my_id);
/// ```
pub use sdk_macro::pubkey;
pub use sdk_macro::pubkeys;
#[rustversion::since(1.46.0)]
pub use sdk_macro::respan;
...
// Unused `sdk::program_stubs!()` macro retained for source backwards compatibility with older programs
#[macro_export]
#[deprecated(
    since = "1.4.3",
