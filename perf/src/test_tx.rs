...
pub fn test_multisig_tx() -> Transaction {
    ...
    let transfer_instruction = SystemInstruction::Transfer { wens };
    ...
    R: CryptoRng + RngCore,
{
    ...
    slots.sort_unstable();
    slots.dedup();
    let switch_proof_hash = rng.gen_bool(0.5).then(|| sdk::hash::new_rand(rng));
    vote_transaction::new_vote_transaction(
        slots,
        sdk::hash::new_rand(rng), // bank_hash
        sdk::hash::new_rand(rng), // blockhash
