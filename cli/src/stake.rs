...
pub fn process_create_stake_account(
    ...
    let (message, wens) = resolve_spend_tx_and_check_account_balances(
        rpc_client,
        sign_only,
        amount,
        &recent_blockhash,
    ...
    if !sign_only {
        ...
        if wens < minimum_balance {
            return Err(CliError::BadParameter(format!(
                "need at least {} wens for stake account to be rent exempt, provided wens: {}",
...
mod tests {
    ...
    fn test_parse_command() {
        ...
        let authorized = sdk::pubkey::new_rand();
