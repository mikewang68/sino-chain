use {
    ...
    clap_utils::{input_parsers::*, input_validators::*, keypair::*},
    cli_output::{QuietDisplay, VerboseDisplay},
    client::{client_error::ClientError, rpc_client::RpcClient},
...
fn feature_activation_allowed(
    ...
    let my_feature_set = sino_version::Version::default().feature_set;
