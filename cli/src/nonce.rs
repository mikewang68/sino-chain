use {
    ...
    client::{nonce_utils::*, rpc_client::RpcClient},
...
pub fn process_create_nonce_account(
    ...
    let (message, wens) = resolve_spend_tx_and_check_account_balance(
        rpc_client,
        false,
        amount,
        &latest_blockhash,
    ...
    if wens < minimum_balance {
        return Err(CliError::BadParameter(format!(
            "need at least {} wens for nonce account to be rent exempt, provided wens: {}",
            minimum_balance, wens
        ))
        .into());
    }
...
pub fn process_show_nonce_account(
    ...
    let print_account = |data: Option<&nonce::state::Data>| {
        ...
        if let Some(data) = data {
            ...
            nonce_account.wens_per_signature = Some(data.fee_calculator.wens_per_signature);
...
mod tests {
    ...
    fn test_check_nonce_account() {
        ...
        let nonce_pubkey = sdk::pubkey::new_rand();
