use {
    ...
    clap_utils::{self, nonce::NonceArgs, offline::OfflineArgs, fee_payer::fee_payer_arg, memo::memo_arg, input_validators::*, keypair::*},
    ...
    App::new(name)
            ...
            SubCommand::with_name("airdrop")
                ...
                .arg(
                    Arg::with_name("faucet_port")
                        ...
                        .takes_value(true)
                        .default_value(faucet::faucet::FAUCET_PORT_STR)
        ...
        .arg(
            Arg::with_name("websocket_url")
                ...
                .global(true)
                .validator(is_url)
                .help("WebSocket URL for the sino cluster"),
        )
        .arg(
        ...
        .subcommand(
            SubCommand::with_name("config")
                .about("Sino command-line tool configuration settings")
                .aliases(&["get", "set"])
                .setting(AppSettings::SubcommandRequiredElseHelp)
                .subcommand(
