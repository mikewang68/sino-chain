use {
    ...
    account_decoder::validator_info::{
    ...
    config_program::{config_instruction, get_config_data, ConfigKeys, ConfigState},
...
fn parse_validator_info(
    ...
    if account.owner != config_program::id() {
...
pub fn process_set_validator_info(
    ...
    let all_config = rpc_client.get_program_accounts(&config_program::id())?;
    ...
    let wens = rpc_client.get_minimum_balance_for_rent_exemption(data_len as usize)?;
