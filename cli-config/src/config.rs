...
lazy_static! {
    ...
    pub static ref CONFIG_FILE: Option<String> = {
        dirs_next::home_dir().map(|mut path| {
            path.extend([".config", "sino", "cli", "config.yml"]);
...
pub struct Config {
    ...
    ///
    /// [rpcdocs]: https://docs.sino.com/cluster/rpc-endpoints
    ...
    /// documentation for `clap_utils::keypair::signer_from_path`.
    ...
    /// `sdk::commitment_config::CommitmentLevel::Confirmed`.
    #[serde(default)]
