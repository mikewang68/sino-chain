...
//!
//! In Sino, programs execute instructions, and clients submit sequences
//! of instructions to the network to be atomically executed as [`Transaction`]s.
//!
//! [`Transaction`]: https://docs.rs/sdk/latest/sdk/transaction/struct.Transaction.html
//!
...
//!
//! [recent blockhash]: https://docs.sino.com/developing/programming-model/transactions#recent-blockhash
//!
...
//! version as of Sino 1.10.0. `v0` is a [future message format] that encodes
...
//!
//! Despite living in the `sino-program` crate, there is no way to access the
//! runtime's messages from within a Sino program, and only the legacy message
//! types continue to be exposed to Sino programs, for backwards compatibility
//! reasons.
...
///
/// [PoH]: https://docs.sino.com/cluster/synchronization
